    ...
    <>
      ...
      >
        ...
        <div className="shrink-0 flex items-center justify-between px-4 py-3 border-b border-border">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-lg text-muted-foreground hover:text-muted-foreground hover:bg-muted transition-all"
          >
        ...
        {isDragging && (
          <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm border-2 border-dashed border-blue-400/50 rounded-xl pointer-events-none">
            <div className="text-center space-y-3">
              ...
              <p className="text-blue-300 font-medium text-sm">Drop files to attach</p>
            ...
            {messages.length === 0 && (
              <div className="text-center py-6 space-y-5">
                ...
                <div
                  ...
                  className="border-2 border-dashed border-border hover:border-blue-500/30 rounded-xl p-4 cursor-pointer transition-all hover:bg-blue-500/5 group"
                >
                  <div className="space-y-1.5">
                    <svg className="w-6 h-6 text-muted-foreground group-hover:text-blue-400/60 mx-auto transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="border-t border-border shrink-0">
          ...
          <div className="px-4 py-3">
            <div className="flex gap-2 items-end">
              ...
              <button
                onClick={() => fileInputRef.current?.click()}
                className="p-2.5 bg-muted hover:bg-muted border border-border rounded-lg text-muted-foreground hover:text-muted-foreground transition-all shrink-0"
                title="Attach files"
              >
