          ...
          {messages.length === 0 && (
            <div className="text-center py-12 space-y-6">
              <div className="space-y-3">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-border">
                  <span className="text-3xl">🤖</span>
                </div>
                <h2 className="text-xl font-semibold text-foreground">Admin Assistant</h2>
                <p className="text-muted-foreground text-sm max-w-lg mx-auto leading-relaxed">
                  I can help you manage invitations, look up companies, view sessions, and build assessments.
                  Paste a CSV, drop a file, or just tell me what you need.
                </p>
              </div>
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground group-hover:text-muted-foreground transition-colors">
                    Drop CSV or files here, or click to browse
                  </p>
              ...
              <div className="grid grid-cols-2 gap-2 max-w-md mx-auto">
                {QUICK_ACTIONS.map((action) => (
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-muted/50 border border-border text-muted-foreground text-sm hover:bg-white/[0.07] hover:text-foreground/90 hover:border-border transition-all text-left"
                  >
          ...
          <div className="max-w-3xl mx-auto flex gap-2 items-end">
            ...
            <div className="flex-1">
              <ChatInput
                onSend={handleSend}
                disabled={isThinking}
                placeholder="Ask me to create invitations, look up companies, manage assessments..."
              />
            </div>
          </div>
        </div>
