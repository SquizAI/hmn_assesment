    ...
    <div className="px-4 md:px-6 py-6 space-y-6">
        ...
        <div className="flex items-center flex-wrap gap-2">
          <div className="relative">
            <input
              ...
              className="bg-muted border border-border rounded-lg pl-9 pr-3 py-2 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-border transition-colors w-full sm:w-56"
            />
            {/* Search icon */}
            <svg
          ...
          <select
            ...
            className="bg-muted border border-border rounded-lg px-3 py-2 text-sm text-muted-foreground outline-none focus:border-border transition-colors"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-muted border border-border rounded-xl px-4 py-3">
          ...
          <p className="text-lg md:text-xl font-semibold text-foreground/90 mt-1 tabular-nums">
            {counts.all}
          </p>
        </div>
        <div className="bg-muted border border-border rounded-xl px-4 py-3">
          ...
          {filtered.map((assessment) => {
            ...
            return (
              <div
                ...
                className={`
                  group relative bg-muted border border-border rounded-2xl p-5
                  hover:bg-muted hover:border-border transition-all cursor-pointer
              ...
              >
                ...
                <div className="mt-3 flex items-center gap-1.5">
                  ...
                  {assessment.category && (
                    <span className="px-2 py-0.5 text-[10px] text-muted-foreground bg-muted rounded-full">
                      {assessment.category}
                    </span>
                  )}
                </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <h3 className="text-sm font-medium text-foreground/90 truncate">{assessment.name}</h3>
                      <StatusBadge status={assessment.status} />
                      {assessment.typeBadge && (
                    ...
                    <p className="text-xs text-muted-foreground truncate mt-0.5">{assessment.description}</p>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 p-1.5 rounded-lg hover:bg-muted text-muted-foreground hover:text-muted-foreground transition-all"
                      title="Edit in Builder"
                    >
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
    ...
    <ModalBackdrop onClose={onClose}>
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mb-5">
          Create a copy of{" "}
          <span className="text-muted-foreground font-medium">{source.name}</span> with
        ...
        <input
          ...
          autoFocus
          className="w-full bg-muted border border-border rounded-lg px-3 py-2 text-sm text-foreground placeholder-white/25 outline-none focus:border-border transition-colors mb-1"
        />
